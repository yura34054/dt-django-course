...
money_transferred_counter = Counter("money_transferred", "money transferred between accounts")
postcard_counter = Counter("postcards_counter", "number of postcards sent")
...
def __send_money(amount, account_from, account_to, card_from=None, card_to=None, postcard=None):
    ...
    money_transferred_counter.inc(amount)
    if has_postcard:
        postcard_counter.inc()
