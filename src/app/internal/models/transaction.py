...
class Transaction(models.Model):
    ...
    card_from = models.ForeignKey(BankCard, blank=True, on_delete=models.CASCADE, related_name="card_from")
    account_from = models.ForeignKey(BankAccount, on_delete=models.CASCADE, related_name="account_from")

    card_to = models.ForeignKey(BankCard, blank=True, on_delete=models.CASCADE, related_name="card_to")
